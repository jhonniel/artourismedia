...
const ICON_FILES: Record<string, string> = {
  ...
  'chart-line': '/images/icons/chart-growth.svg',
  'chart-growth': '/images/icons/chart-growth.svg',
  'graduation-cap': '/images/icons/graduation-cap.svg',
  layers: '/images/icons/layers.svg',
  'stacked-layers': '/images/icons/layers.svg',
  users: '/images/icons/users-group.svg',
  'users-group': '/images/icons/users-group.svg',
  ...
  'tourism-planning': '/images/icons/services/tourism-planning.svg',
  'destination-branding': '/images/icons/services/destination-branding.svg',
  'mice-events': '/images/icons/services/mice-events.svg',
  'learning-leadership': '/images/icons/services/learning-leadership.svg',
  'mindanao-connect': '/images/icons/services/mindanao-connect.svg',
  palette: '/images/icons/tag.svg',
  route: '/images/icons/chart-growth.svg',
  megaphone: '/images/icons/tag.svg',
  leaf: '/images/icons/globe.svg',
  target: '/images/icons/award.svg',
}
