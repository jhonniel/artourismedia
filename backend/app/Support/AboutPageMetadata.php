...
class AboutPageMetadata
{
    public static function defaults(): array
    {
        return [
            ...
            'quote' => 'The Philippine tourism industry has to compete hard and fast with the rest of the world today and place the sustainability of host communities and business stakeholders at the heart of its efforts.',
            'career_heading' => '',
            ...
            'leadership' => [
                ['title' => 'Group General Manager', 'organization' => 'Megaworld Hotels and Resorts', 'icon' => 'hotel'],
                ['title' => 'Executive Vice President & Chief Operating Officer', 'organization' => 'World Trade Center Metro Manila', 'icon' => 'convention-center'],
                ['title' => 'Regional Director, Assistant Secretary, and Undersecretary', 'organization' => 'Philippine Department of Tourism', 'icon' => 'government-tourism'],
                ['title' => 'Assistant Secretary', 'organization' => 'Department of Trade and Industry (ADB Summit)', 'icon' => 'trade-industry'],
                ['title' => 'Tourism & Hospitality Executive', 'organization' => 'ArTourisMedia', 'icon' => 'tourism-media'],
            ],
